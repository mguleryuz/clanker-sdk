export const ClankerUniv3EthDevBuy_v4_abi = [
  {
    type: 'constructor',
    inputs: [
  ...
  },
  {
    ...
    name: 'swapRouter',
    inputs: [],
    outputs: [{ name: '', type: 'address', internalType: 'contract ISwapRouterV3' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
...
/**
 * ABI for encoding the V3 DevBuy extension data.
 * Structure: (uniV3Fee, pairedTokenAmountOutMinimum, recipient)
 */
export const ClankerUniv3EthDevBuy_Instantiation_v4_abi = [
